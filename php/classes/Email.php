...
class Email {
    function sendEmail($email,$lastname,$username,$password,$subject){
        ...
        $mail->isSMTP();
        $mail->SMTPAuth = true;
        $mail->Username = "wmakwesheni@gmail.com";
        $mail->Password = "@Subaru@2022";
        $mail->SMTPSecure = "tls"; //TLS
        $mail->Port = 587; //587
        $mail->addAddress($email);
        $mail->setFrom('wmakwesheni@gmail.com', 'EXIT-TB Data Management System');
        $mail->addReplyTo('wmakwesheni@gmail.com');
        $mail->addCC('wmakwesheni@gmail.com');
        $mail->addBCC('wmakwesheni@gmail.com');
    ...
    function resetPassword($email,$lastname,$subject,$link){
        ...
        $mail->Port = 587; //587
        $mail->addAddress($email);
        $mail->setFrom('wmakwesheni@gmail.com','Electronic Clinical Trial Database Management System');
        $mail->addReplyTo('wmakwesheni@gmail.com');
        $mail->addCC('wmakwesheni@gmail.com');
        $mail->addBCC('wmakwesheni@gmail.com');
        $mail->Subject = $subject;
